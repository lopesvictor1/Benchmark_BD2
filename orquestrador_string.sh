...
#        python3.7 influxdb_queries_string.py --suppliers $suppliers --parts 100 >> out_string.txt
#    done
#done
...
do
	...
	echo "PostgreSQL Execution $k: Suppliers = $suppliers; Parts = 100"
        python3.7 postgresql_queries_string.py --suppliers $suppliers --parts 100 >> out_string.txt
    done
done
