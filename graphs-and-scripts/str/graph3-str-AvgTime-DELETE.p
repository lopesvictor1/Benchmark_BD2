...
set output 'graph3-str-AvgDB_avgDELETE.eps'
...
plot 'AVG-STR-DB.out' using 4:xtic(1) title 'InfluxDB(str)' fs pattern 4 lt -1, \
'' using 7:xtic(1) title 'PostgreSQL(str)' fs pattern 2 lt -1