...
set output 'graph1-str-AvgDB_avgINSERT.eps'
...
plot 'AVG-STR-DB.out' using 2:xtic(1) title 'InfluxDB(str)' fs pattern 4 lt -1, \
'' using 5:xtic(1) title 'PostgreSQL(str)' fs pattern 2 lt -1