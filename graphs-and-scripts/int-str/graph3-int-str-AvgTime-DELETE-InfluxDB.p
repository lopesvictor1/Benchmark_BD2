...
set output 'graph3-int-str-AvgDB_avgDELETE-InfluxDB.eps'
...
plot 'AVG-INT-DB.out' using 4:xtic(1) title 'InfluxDB(int)' fs pattern 4 lt -1, \
     'AVG-STR-DB.out' using 4:xtic(1) title 'InfluxDB(str)' fs pattern 2 lt -1