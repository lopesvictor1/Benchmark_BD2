...
set output 'graph2-int-str-AvgDB_avgUPDATE-InfluxDB.eps'
...
plot 'AVG-INT-DB.out' using 3:xtic(1) title 'InfluxDB(int)' fs pattern 4 lt -1, \
     'AVG-STR-DB.out' using 3:xtic(1) title 'InfluxDB(str)' fs pattern 2 lt -1