...
set output 'graph1-int-str-AvgDB_avgINSERT-InfluxDB.eps'
...
plot 'AVG-INT-DB.out' using 2:xtic(1) title 'InfluxDB(int)' fs pattern 4 lt -1, \
     'AVG-STR-DB.out' using 2:xtic(1) title 'InfluxDB(str)' fs pattern 2 lt -1